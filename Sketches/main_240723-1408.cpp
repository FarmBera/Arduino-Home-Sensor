...
// const char sdInitFailMsg[] PROGMEM = "SD card initialization failed!";
// const char sdInitMsg1[] PROGMEM=""

const String FILE_PATH = "roomtemp.txt";
File myFile;
short logState = 0;
  ...
  if (client)
  {
    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == '\n' && currentLineIsBlank)
        {
          File dataFile = SD.open(FILE_PATH.c_str());
          if (dataFile)
          {
